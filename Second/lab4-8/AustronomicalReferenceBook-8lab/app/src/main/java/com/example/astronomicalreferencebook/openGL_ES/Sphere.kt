package com.example.astronomicalreferencebook.openGL_ES
...
class Sphere(private val latitudeBands: Int = 40, private val longitudeBands: Int = 40, val radius: Float = 1.0f) {
